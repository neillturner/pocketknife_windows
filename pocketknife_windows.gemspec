...
With pocketknife, all of your cookbooks, roles and nodes are stored in easy-to-use files that you can edit, share, backup and version control with tools you already have.
  ...
  s.executables = ["pocketknife_windows", "pocketknife_windows"]
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.md"
  ]
  s.files = [
    ...
    "README.md",
    "Rakefile",
    "bin/pocketknife_windows",
    "lib/pocketknife_windows.rb",
    "lib/pocketknife_windows/errors.rb",
  ...
  s.homepage = %q{http://github.com/neillturner/pocketknife_windows}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
